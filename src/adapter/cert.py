...
def generate_drone_cert_base64(image, hull_number, owner):
    """
    Generates a drone certificate and returns it as a base64 string.

    :param image: Path to the drone image
    :param hull_number: Hull number of the drone
    :param owner: Owner of the drone
    ...
    # Create a blank certificate canvas
